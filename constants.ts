...
export const PROJECTS: TranslationProject[] = [
  ...
  },
  {
    ...
    genre: 'Action RPG',
    releaseDate: '',
    description: 'Persona Q2: New Cinema Labyrinth - это японская ролевая игра, рассказывающая о событиях, происходящих в стороне от основных игр серии. В центре внимания - герои Persona 3, Persona 4 и Persona 5, которые встречаются вместе в крайне необычном месте — кинотеатре, где в каждом из залов их ждут новые игровые истории и задачи. ',
